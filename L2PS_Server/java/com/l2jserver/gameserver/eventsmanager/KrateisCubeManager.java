...
import com.l2jserver.gameserver.network.serverpackets.ExKrateiMatchCCMyRecord;
import com.l2jserver.gameserver.network.serverpackets.ExKrateiMatchCCRecord;
...
public class KrateisCubeManager
{
	...
	protected static int _fantasyCoin = 13067;
	...
	public void init()
	{
		...
		{
			if ((spawn != null) && (spawn.getNpcid() == MANAGER))
			{
				_managers.add(spawn);
			}
		}
	...
	protected void ManagerSay(String msg)
	{
		...
		for (L2Spawn spawn : _managers)
		{
			...
			if (manager != null)
			{
				packet = new NpcSay(manager.getObjectId(), Say2.ALL, manager.getNpcId(), msg);
