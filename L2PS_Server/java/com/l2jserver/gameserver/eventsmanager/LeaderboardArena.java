...
public class LeaderboardArena
{
	private static LeaderboardArena		_instance;
	...
	public static LeaderboardArena getInstance()
	{
		if (_instance == null)
			_instance = new LeaderboardArena();

		return _instance;
	}
	
	public LeaderboardArena()
	{
		engineInit();
	}
