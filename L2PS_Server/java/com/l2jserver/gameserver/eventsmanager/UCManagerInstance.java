...
public class UCManagerInstance extends L2Npc
{
	public UCManagerInstance(int objectId, L2NpcTemplate template)
	{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		if (actualCommand.equalsIgnoreCase("register"))
		{
			try
			{
				...
				if (!UCManager.getInstance().isStarted())
				{
				...
				UCArena arena = UCManager.getInstance().getArena(val);
				if (arena == null)
				{
