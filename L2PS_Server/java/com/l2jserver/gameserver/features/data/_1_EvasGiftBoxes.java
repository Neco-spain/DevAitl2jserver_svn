 ...
 * @author Gigiikun
 */
public class _1_EvasGiftBoxes extends AbstractNpcAI
{
	...
	private _1_EvasGiftBoxes(String name, String descr)
	{
		super(name, descr);
		addKillId(GIFTBOX);
		addSpawnId(GIFTBOX);
	...
	{
		new _1_EvasGiftBoxes(_1_EvasGiftBoxes.class.getSimpleName(), "data");
	}
}