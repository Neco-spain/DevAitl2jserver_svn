...
public class _1_MercenaryCaptain extends Quest
{
	...
	protected static final NpcStringId[] dlog =
	{
	...
	public _1_MercenaryCaptain(int questId, String name, String descr)
	{
	...
	{
		new _1_MercenaryCaptain(-1, "MercenaryCaptain", "data");
	}
