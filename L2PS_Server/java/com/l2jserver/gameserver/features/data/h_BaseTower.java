 ...
 * @author GKR
 */
public class h_BaseTower extends Quest
{
	...
	public h_BaseTower(int questId, String name, String descr)
	{
	...
	{
		new h_BaseTower(-1, h_BaseTower.class.getSimpleName(), "hellbound");
	}
}
