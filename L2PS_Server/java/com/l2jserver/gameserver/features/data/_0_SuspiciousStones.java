...
public class _0_SuspiciousStones extends AbstractNpcAI
{
	...
	public _0_SuspiciousStones(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_SuspiciousStones(_0_SuspiciousStones.class.getSimpleName(), "data");
	}
}
