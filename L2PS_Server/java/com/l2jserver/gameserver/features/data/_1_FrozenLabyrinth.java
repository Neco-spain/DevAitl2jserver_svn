 ...
 * @author malyelfik
 */
public final class _1_FrozenLabyrinth extends AbstractNpcAI
{
	// Monsters
	...
	private _1_FrozenLabyrinth(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_FrozenLabyrinth(_1_FrozenLabyrinth.class.getSimpleName(), "ai/group_template");
	}
}