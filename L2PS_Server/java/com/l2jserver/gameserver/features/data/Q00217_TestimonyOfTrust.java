...
public class Q00217_TestimonyOfTrust extends Quest
{
	...
	public Q00217_TestimonyOfTrust(int questId, String name, String descr)
	{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if ((npcId == 20036) || (npcId == 20044))
		{
			if ((cond == 2) && (st.getQuestItemsCount(BREATH_OF_WINDS_ID) == 0))
			{
				...
				if (Rnd.get(100) < (st.getInt("id") * 33))
				{
		...
		{
			if ((cond == 14) && (st.getQuestItemsCount(PARASITE_OF_LOTA_ID) < 10) && (Rnd.get(100) < 50))
			{
	...
	{
		new Q00217_TestimonyOfTrust(217, Q00217_TestimonyOfTrust.class.getSimpleName(), "Testimony Of Trust");
	}
}