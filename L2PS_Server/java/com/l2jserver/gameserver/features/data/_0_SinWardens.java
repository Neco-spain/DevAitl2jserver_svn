 ...
 * @author GKR
 */
public class _0_SinWardens extends AbstractNpcAI
{
	...
	private _0_SinWardens(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_SinWardens(_0_SinWardens.class.getSimpleName(), "data");
	}
}
