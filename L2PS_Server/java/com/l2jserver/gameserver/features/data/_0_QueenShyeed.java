 ...
 * @author malyelfik
 */
public class _0_QueenShyeed extends AbstractNpcAI
{
	// NPC
	...
	public _0_QueenShyeed(String name, String descr)
	{
		super(name, descr);
		addKillId(SHYEED);
		spawnShyeed();
	...
	{
		new _0_QueenShyeed(_0_QueenShyeed.class.getSimpleName(), "data");
	}
}