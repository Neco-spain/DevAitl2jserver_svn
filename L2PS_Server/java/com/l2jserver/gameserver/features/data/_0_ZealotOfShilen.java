...
public class _0_ZealotOfShilen extends AbstractNpcAI
{
	...
	public _0_ZealotOfShilen(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_ZealotOfShilen(_0_ZealotOfShilen.class.getSimpleName(), "data");
	}
}
