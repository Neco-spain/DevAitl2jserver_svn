...
public class _4_ChamberOfDelusionEast extends Quest
{
	...
	public _4_ChamberOfDelusionEast(int questId, String name, String descr)
	{
	...
	{
		new _4_ChamberOfDelusionEast(-1, qn, "instances");
	}
}