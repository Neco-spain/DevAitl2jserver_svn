 ...
 * @author Adry_85
 */
public class _0_DragonScout extends AbstractNpcAI
{
	...
	private _0_DragonScout(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_DragonScout(_0_DragonScout.class.getSimpleName(), "data");
	}
}
