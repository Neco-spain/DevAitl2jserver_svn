...
public class Q00625_TheFinestIngredientsPart2 extends Quest
{
	...
	public Q00625_TheFinestIngredientsPart2(int questId, String name, String descr)
	{
		...
		{
			case UNDEFINED:
				_log.log(Level.WARNING, getName() + ": can not find spawned L2RaidBoss id=" + ICICLE_EMPEROR_BUMBALUMP);
				break;
	...
	{
		new Q00625_TheFinestIngredientsPart2(625, Q00625_TheFinestIngredientsPart2.class.getSimpleName(), "The Finest Ingredients Part 2");
	}
}