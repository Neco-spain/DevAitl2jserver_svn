 ...
 */
public class Sagas3rdClass extends Quest
{
	...
	public Sagas3rdClass(int id, String name, String descr)
	{
		super(id, name, descr);
		qnu = id;
	}
	...
	public static void main(String[] args)
	{
		...
		new Sagas3rdClass(-1, "SagasSuperClass", "Saga's SuperClass");
		...
		_scripts.add(new Q00071_SagaOfTheEvasTemplar());
		_scripts.add(new Q00072_SagaOfTheSwordMuse());
		_scripts.add(new Q00073_SagaOfTheDuelist());
		_scripts.add(new Q00074_SagaOfTheDreadnoughts());
		...
		_scripts.add(new Q00087_SagaOfTheEvasSaint());
