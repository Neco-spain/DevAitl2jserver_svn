...
public final class Q00187_NikolasHeart extends Quest
{
	...
	public Q00187_NikolasHeart(int questId, String name, String descr)
	{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch (st.getState())
		{
			case State.CREATED:
				...
				QuestState qs1 = player.getQuestState("Q00186_ContractExecution");
	...
	{
		new Q00187_NikolasHeart(187, Q00187_NikolasHeart.class.getSimpleName(), "Nikolas Heart");
	}
}