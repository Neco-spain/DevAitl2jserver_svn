...
/*
 * Author:
 * 	L2PS Team: Millu, Andrewer
 * Rework:
 * 	L2PS: RobikBobik
 */

public class _4_Zaken extends AbstractNpcAI
{
	...
	private boolean checkConditions(L2PcInstance player, String choice)
	{
		...
		int minLevel = 0;
		int minMembers = Config.MIN_ZAKEN_DAY_PLAYERS;
		int maxMembers = Config.MAX_ZAKEN_DAY_PLAYERS;
		...
		{
			minMembers = Config.MIN_ZAKEN_NIGHT_PLAYERS;
			maxMembers = Config.MAX_ZAKEN_NIGHT_PLAYERS;
		}
	...
	public _4_Zaken(int questId, String name, String descr)
	{
		super(name, descr);
