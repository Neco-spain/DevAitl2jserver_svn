...
public class _0_TurekOrcFootman extends AbstractNpcAI
{
	private static final int TUREK_ORC_FOOTMAN = 20499;
	
	public _0_TurekOrcFootman(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_TurekOrcFootman(-1, "TurekOrcFootman", "data");
	}
}