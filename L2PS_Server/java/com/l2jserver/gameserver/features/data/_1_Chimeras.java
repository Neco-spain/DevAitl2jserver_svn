 ...
 * @author DS
 */
public class _1_Chimeras extends AbstractNpcAI
{
	// NPCs
	...
	private _1_Chimeras(int questId, String name, String descr)
	{
		super(name, descr);
		addSkillSeeId(NPCS);
		addSpawnId(CELTUS);
	...
	{
		new _1_Chimeras(-1, _1_Chimeras.class.getSimpleName(), "data");
	}
}
