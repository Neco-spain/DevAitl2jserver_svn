 ...
 * @author GKR
 */
public class _1_RandomSpawn extends AbstractNpcAI
{
	...
	public _1_RandomSpawn(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_RandomSpawn(_1_RandomSpawn.class.getSimpleName(), "data");
	}
}
