 ...
 * @author Adry_85
 */
public class _0_DragonTracker extends AbstractNpcAI
{
	private static final int DRAGON_TRACKER_ID = 22831;
	
	private static final int ROUTE_ID = 25;
	
	private _0_DragonTracker(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_DragonTracker(_0_DragonTracker.class.getSimpleName(), "data");
	}
}
