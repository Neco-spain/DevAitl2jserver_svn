...
public class Q00257_TheGuardIsBusy extends Quest
{
	...
	public Q00257_TheGuardIsBusy(int questId, String name, String descr)
	{
			...
			else
			{
				...
				if ((newbie | NEWBIE_REWARD) != newbie)
				{
					...
					if (player.getClassId().isMage())
					{
						...
						// TODO:
						// player.sendPacket(new ExShowScreenMessage(((new Message("Newbie.Message2", player.getLang())).toString()), 3000));
					}
					else
					{
						...
						// TODO:
						// player.sendPacket(new ExShowScreenMessage(((new Message("Newbie.Message2a", player.getLang())).toString()), 3000));
					}
				}
