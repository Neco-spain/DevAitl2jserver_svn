...
public class _0_CannibalisticStakatoChief extends AbstractNpcAI
{
	...
	public _0_CannibalisticStakatoChief(int questId, String name, String descr)
	{
		super(name, descr);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		...
		addSpawn(_captainSpawn.get(npc.getObjectId()).intValue(), npc.getSpawn().getLocx(), npc.getSpawn().getLocy(), npc.getSpawn().getLocz(), 0, false, 0);
	...
	{
		new _0_CannibalisticStakatoChief(-1, "CannibalisticStakatoChief", "data");
	}
}