...
public class _0_BodyDestroyer extends AbstractNpcAI
{
	private static final int BDESTROYER = 40055;
	
	boolean _isLocked = false;
	
	public _0_BodyDestroyer(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_BodyDestroyer(-1, "BodyDestroyer", "data");
	}
}