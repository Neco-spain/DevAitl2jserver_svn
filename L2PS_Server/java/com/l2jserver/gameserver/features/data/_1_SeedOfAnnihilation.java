 ...
 * @author Gigiikun
 */
public class _1_SeedOfAnnihilation extends AbstractNpcAI
{
	...
	private _1_SeedOfAnnihilation(String name, String descr)
	{
		super(name, descr);
		loadSeedRegionData();
	...
	{
		new _1_SeedOfAnnihilation(_1_SeedOfAnnihilation.class.getSimpleName(), "data");
	}
}