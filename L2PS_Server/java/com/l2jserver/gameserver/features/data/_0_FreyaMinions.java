...
public class _0_FreyaMinions extends AbstractNpcAI
{
	...
	public _0_FreyaMinions(int questId, String name, String descr)
	{
		super(name, descr);
		int[] mobs =
		{
	...
	{
		new _0_FreyaMinions(-1, _0_FreyaMinions.class.getSimpleName(), "instances");
	}
}