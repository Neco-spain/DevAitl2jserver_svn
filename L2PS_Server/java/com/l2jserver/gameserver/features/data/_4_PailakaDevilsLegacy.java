...
public class _4_PailakaDevilsLegacy extends Quest
{
	private static final String qn = "129_PailakaDevilsLegacy";
	
	protected static final Logger _log = Logger.getLogger(_4_PailakaDevilsLegacy.class.getName());
	...
	public _4_PailakaDevilsLegacy(int questId, String name, String descr)
	{
	...
	{
		new _4_PailakaDevilsLegacy(129, qn, "Pailaka - Devil's Legacy");
	}
}