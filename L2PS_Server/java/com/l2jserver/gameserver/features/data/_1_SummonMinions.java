 ...
 * @author Sandro
 */
public class _1_SummonMinions extends AbstractNpcAI
{
	...
	private _1_SummonMinions(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_SummonMinions(_1_SummonMinions.class.getSimpleName(), "data");
	}
}
