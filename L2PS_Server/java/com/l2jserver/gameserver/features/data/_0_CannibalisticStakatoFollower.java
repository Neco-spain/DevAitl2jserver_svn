...
public class _0_CannibalisticStakatoFollower extends AbstractNpcAI
{
	private static final int CANNIBALISTIC_LEADER = 22625;
	
	public _0_CannibalisticStakatoFollower(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_CannibalisticStakatoFollower(-1, "CannibalisticStakatoFollower", "data");
	}
