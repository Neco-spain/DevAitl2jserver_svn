 ...
 */
public class _0_NecromancerValley extends AbstractNpcAI
{
	...
	private _0_NecromancerValley(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_NecromancerValley(_0_NecromancerValley.class.getSimpleName(), "data");
	}
}
