 ...
 * @author DS
 */
public class _0_OutpostCaptain extends AbstractNpcAI
{
	...
	private _0_OutpostCaptain(String name, String descr)
	{
		super(name, descr);
		addKillId(CAPTAIN);
	...
	{
		new _0_OutpostCaptain(_0_OutpostCaptain.class.getSimpleName(), "data");
	}
}
