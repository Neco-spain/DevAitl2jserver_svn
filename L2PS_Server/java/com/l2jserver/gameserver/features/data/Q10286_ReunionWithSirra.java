...
public class Q10286_ReunionWithSirra extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (npc.getNpcId() == _rafforty)
		{
			...
			else if (("32020-05.htm".equals(event)) && (st.getInt("progress") == 1))
			{
				st.set("Ex", "0");
			}
		}
		...
		else if (npc.getNpcId() == _jinia)
		{
			...
			else if (("32760-09.htm".equals(event)) && (st.getInt("progress") == 1) && (st.getInt("Ex") == 2))
			{
				st.set("progress", "2");
		...
		{
			if (("32762-04.htm".equals(event)) && (st.getInt("progress") == 1) && (st.getInt("Ex") == 1))
			{
