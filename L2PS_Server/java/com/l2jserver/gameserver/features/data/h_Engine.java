...
public class h_Engine extends Quest implements Runnable
{
	...
	public h_Engine(int questId, String name, String descr)
	{
	...
	{
		new h_Engine(-1, h_Engine.class.getSimpleName(), "hellbound");
	}
}
