...
public final class Config
{
	...
	// Bosses/
	public static final String ANTHARAS_CONFIG = "./config/Bosses/Antharas.properties";
	public static final String VALAKAS_CONFIG = "./config/Bosses/Valakas.properties";
	...
	public static final String FANTASY_ISLE_TOURNAMENT = "./config/Events/FantasyIsleTournament.properties";
	public static final String FORTSIEGE_CONFIGURATION_FILE = "./config/Events/FortSiege.properties";
	public static final String CHAMPION_CONFIG = "./config/Events/Champions.properties";
	public static final String OLYMPIAD_CONFIG_FILE = "./config/Events/Olympiad.properties";
	public static final String PCBANG_CONFIG_FILE = "./config/Events/PcCafe.properties";
	public static final String PSMODS_CONFIG_FILE = "./config/Events/PsMods.properties";
	public static final String PVP_COLOR_SYSTEM = "./config/Events/PvPColor.properties";
	public static final String RANK_MNGR = "./config/Events/RankManager.properties";
	public static final String SIEGE_CONFIGURATION_FILE = "./config/Events/Siege.properties";
	public static final String TW_CONFIGURATION_FILE = "./config/Events/TerritoryWar.properties";
	public static final String WEDDING = "./config/Events/Wedding.properties";
	// Engine Events/
	public static final String EVENT_ENGINE = "./config/EventsEngine/OnOff_Engine.properties";
	// Hexid/
	public static final String HEXID_FILE = "./config/Hexid/hexid.txt";
	// InGame/
	public static final String NPC_BUFFER = "./config/InGame/Buffer.properties";
	...
	public static final String LOOT_MODS = "./config/InGame/LootMods.properties";
	public static final String NPC_CONFIG_FILE = "./config/InGame/NPC.properties";
	public static final String OFFLINE_SHOP = "./config/InGame/OfflineShop.properties";
	...
	public static int SMALLER_FOR_MAGE;
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			{
				_log.warning("Config: " + e.getMessage());
				throw new Error("Failed to Load " + VOICED_COMMANDS + " File.");
			}
			
			// Load vote L2Properties file (if exists)
			final File vote2 = new File(VOTE_EVENT);
			try (InputStream is = new FileInputStream(vote2))
			{
			...
			final File offline = new File(OFFLINE_SHOP);
			...
			{
				_log.warning("Config: " + e.getMessage());
				throw new Error("Failed to Load " + OFFLINE_SHOP + " File.");
			}
			
			// Load Event Engine L2Properties file (if exists)
			final File wed = new File(WEDDING);
			try (InputStream is = new FileInputStream(wed))
			{
				...
				WEDDING_TELEPORT_PRICE = Integer.parseInt(wedding.getProperty("WeddingTeleportPrice", "50000"));
				WEDDING_TELEPORT_DURATION = Integer.parseInt(wedding.getProperty("WeddingTeleportDuration", "60"));
				WEDDING_SAMESEX = Boolean.parseBoolean(wedding.getProperty("WeddingAllowSameSex", "False"));
				WEDDING_FORMALWEAR = Boolean.parseBoolean(wedding.getProperty("WeddingFormalWear", "True"));
				WEDDING_DIVORCE_COSTS = Integer.parseInt(wedding.getProperty("WeddingDivorceCosts", "20"));
			}
			catch (Exception e)
			{
				_log.warning("Config: " + e.getMessage());
				throw new Error("Failed to Load " + WEDDING + " File.");
			}
			
			// Load Event_Engine L2Properties file (if exists)
			final File eng = new File(EVENT_ENGINE);
			...
			{
				_log.warning("Config: " + e.getMessage());
				throw new Error("Failed to Load " + EVENT_ENGINE + " File.");
			}
			
			// Load CHAMPION_CONFIG L2Properties file (if exists)
			final File champ = new File(CHAMPION_CONFIG);
			try (InputStream is = new FileInputStream(champ))
			{
				L2Properties champions = new L2Properties();
				champions.load(is);
				CHAMPION_ENABLE = Boolean.parseBoolean(champions.getProperty("ChampionEnable", "false"));
				CHAMPION_PASSIVE = Boolean.parseBoolean(champions.getProperty("ChampionPassive", "false"));
				CHAMPION_FREQUENCY = Integer.parseInt(champions.getProperty("ChampionFrequency", "0"));
				CHAMP_TITLE = champions.getProperty("ChampionTitle", "Champion");
				CHAMP_MIN_LVL = Integer.parseInt(champions.getProperty("ChampionMinLevel", "20"));
				CHAMP_MAX_LVL = Integer.parseInt(champions.getProperty("ChampionMaxLevel", "60"));
				CHAMPION_HP = Integer.parseInt(champions.getProperty("ChampionHp", "7"));
				CHAMPION_HP_REGEN = Float.parseFloat(champions.getProperty("ChampionHpRegen", "1."));
				CHAMPION_REWARDS = Integer.parseInt(champions.getProperty("ChampionRewards", "8"));
				CHAMPION_ADENAS_REWARDS = Float.parseFloat(champions.getProperty("ChampionAdenasRewards", "1"));
				CHAMPION_ATK = Float.parseFloat(champions.getProperty("ChampionAtk", "1."));
				CHAMPION_SPD_ATK = Float.parseFloat(champions.getProperty("ChampionSpdAtk", "1."));
				CHAMPION_REWARD_LOWER_LVL_ITEM_CHANCE = Integer.parseInt(champions.getProperty("ChampionRewardLowerLvlItemChance", "0"));
				CHAMPION_REWARD_HIGHER_LVL_ITEM_CHANCE = Integer.parseInt(champions.getProperty("ChampionRewardHigherLvlItemChance", "0"));
				CHAMPION_REWARD_ID = Integer.parseInt(champions.getProperty("ChampionRewardItemID", "6393"));
				CHAMPION_REWARD_QTY = Integer.parseInt(champions.getProperty("ChampionRewardItemQty", "1"));
				CHAMPION_ENABLE_VITALITY = Boolean.parseBoolean(champions.getProperty("ChampionEnableVitality", "False"));
				CHAMPION_ENABLE_IN_INSTANCES = Boolean.parseBoolean(champions.getProperty("ChampionEnableInInstances", "False"));
			}
			catch (Exception e)
			{
				_log.warning("Config: " + e.getMessage());
				throw new Error("Failed to Load " + CHAMPION_CONFIG + " File.");
			}
			
			// Load rank manager L2Properties file (if exists)
			final File rank = new File(RANK_MNGR);
			try (InputStream is = new FileInputStream(rank))
			{
				L2Properties rank_manager = new L2Properties();
				rank_manager.load(is);
				RANK_ARENA_ACCEPT_SAME_IP = Boolean.parseBoolean(rank_manager.getProperty("ArenaAcceptSameIP", "true"));
				RANK_ARENA_ENABLED = Boolean.parseBoolean(rank_manager.getProperty("RankArenaEnabled", "false"));
				RANK_ARENA_INTERVAL = Integer.parseInt(rank_manager.getProperty("RankArenaInterval", "120"));
				RANK_ARENA_REWARD_ID = Integer.parseInt(rank_manager.getProperty("RankArenaRewardId", "57"));
				RANK_ARENA_REWARD_COUNT = Integer.parseInt(rank_manager.getProperty("RankArenaRewardCount", "1000"));
				RANK_FISHERMAN_ENABLED = Boolean.parseBoolean(rank_manager.getProperty("RankFishermanEnabled", "false"));
				RANK_FISHERMAN_INTERVAL = Integer.parseInt(rank_manager.getProperty("RankFishermanInterval", "120"));
				RANK_FISHERMAN_REWARD_ID = Integer.parseInt(rank_manager.getProperty("RankFishermanRewardId", "57"));
				RANK_FISHERMAN_REWARD_COUNT = Integer.parseInt(rank_manager.getProperty("RankFishermanRewardCount", "1000"));
				RANK_CRAFT_ENABLED = Boolean.parseBoolean(rank_manager.getProperty("RankCraftEnabled", "false"));
				RANK_CRAFT_INTERVAL = Integer.parseInt(rank_manager.getProperty("RankCraftInterval", "120"));
				RANK_CRAFT_REWARD_ID = Integer.parseInt(rank_manager.getProperty("RankCraftRewardId", "57"));
				RANK_CRAFT_REWARD_COUNT = Integer.parseInt(rank_manager.getProperty("RankCraftRewardCount", "1000"));
			}
			catch (Exception e)
			{
				_log.warning("Config: " + e.getMessage());
				throw new Error("Failed to Load " + RANK_MNGR + " File.");
			}
			
			// Load fantasy isle tournament L2Properties file (if exists)
			final File fantasyit = new File(FANTASY_ISLE_TOURNAMENT);
			try (InputStream is = new FileInputStream(fantasyit))
			{
				L2Properties fit = new L2Properties();
				fit.load(is);
				UC_START_HOUR = Integer.parseInt(fit.getProperty("StartHour", "21"));
				UC_END_HOUR = Integer.parseInt(fit.getProperty("EndHour", "23"));
				UC_ROUND_TIME = Integer.parseInt(fit.getProperty("RoundTime", "10"));
				UC_PARTY_LIMIT = Integer.parseInt(fit.getProperty("PartyLimit", "7"));
			}
			catch (Exception e)
			{
				e.printStackTrace();
				throw new Error("Failed to Load " + FANTASY_ISLE_TOURNAMENT + " File.");
			}
			...
			final File pcbangpoints = new File(PCBANG_CONFIG_FILE);
			try (InputStream is = new FileInputStream(pcbangpoints))
			{
				L2Properties pcbs = new L2Properties();
				pcbs.load(is);
				
				PC_BANG_ENABLED = Boolean.parseBoolean(pcbs.getProperty("Enabled", "false"));
				SMALLER_FOR_MAGE = Integer.parseInt(pcbs.getProperty("SmallerForMage", "2"));
				MAX_PC_BANG_POINTS = Integer.parseInt(pcbs.getProperty("MaxPcBangPoints", "200000"));
				if (MAX_PC_BANG_POINTS < 0)
				{
					MAX_PC_BANG_POINTS = 0;
				}
				ENABLE_DOUBLE_PC_BANG_POINTS = Boolean.parseBoolean(pcbs.getProperty("DoublingAcquisitionPoints", "false"));
				DOUBLE_PC_BANG_POINTS_CHANCE = Integer.parseInt(pcbs.getProperty("DoublingAcquisitionPointsChance", "1"));
				if ((DOUBLE_PC_BANG_POINTS_CHANCE < 0) || (DOUBLE_PC_BANG_POINTS_CHANCE > 100))
				{
					DOUBLE_PC_BANG_POINTS_CHANCE = 1;
				}
				PC_BANG_POINT_RATE = Double.parseDouble(pcbs.getProperty("AcquisitionPointsRate", "1.0"));
				if (PC_BANG_POINT_RATE < 0)
				{
					PC_BANG_POINT_RATE = 1;
				}
				RANDOM_PC_BANG_POINT = Boolean.parseBoolean(pcbs.getProperty("AcquisitionPointsRandom", "false"));
			}
			catch (Exception e)
			{
				e.printStackTrace();
			...
			final File npcbuffer = new File(NPC_BUFFER);
			try (InputStream is = new FileInputStream(npcbuffer))
			{
				L2Properties npc_buffer = new L2Properties();
				npc_buffer.load(is);
				NpcBuffer_SmartWindow = Boolean.parseBoolean(npc_buffer.getProperty("EnableSmartWindow", "True"));
				NpcBuffer_VIP = Boolean.parseBoolean(npc_buffer.getProperty("EnableVIP", "False"));
				NpcBuffer_VIP_ALV = Integer.parseInt(npc_buffer.getProperty("VipAccesLevel", "1"));
			...
			final File pvp_color = new File(PVP_COLOR_SYSTEM);
			try (InputStream is = new FileInputStream(pvp_color))
			{
				L2Properties pvp_color_s = new L2Properties();
				pvp_color_s.load(is);
				PVP_TITLE_AND_COLOR_SYSTEM_ENABLED = Boolean.parseBoolean(pvp_color_s.getProperty("EnablePvPColorSystem", "false"));
				PVP_AMOUNT1 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount1", "20"));
				TITLE_COLOR_FOR_PVP_AMOUNT1 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount1", "00FF00"));
				PVP1_TITLE = pvp_color_s.getProperty("TitleForAmount1", "Warrior");
				PVP_AMOUNT2 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount2", "80"));
				TITLE_COLOR_FOR_PVP_AMOUNT2 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount2", "00FF00"));
				PVP2_TITLE = pvp_color_s.getProperty("TitleForAmount2", "Soldier");
				PVP_AMOUNT3 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount3", "140"));
				TITLE_COLOR_FOR_PVP_AMOUNT3 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount3", "00FF00"));
				PVP3_TITLE = pvp_color_s.getProperty("TitleForAmount3", "Elite Soldier");
				PVP_AMOUNT4 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount4", "190"));
				TITLE_COLOR_FOR_PVP_AMOUNT4 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount4", "00FF00"));
				PVP4_TITLE = pvp_color_s.getProperty("TitleForAmount4", "Gladiator");
				PVP_AMOUNT5 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount5", "290"));
				TITLE_COLOR_FOR_PVP_AMOUNT5 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount5", "00FF00"));
				PVP5_TITLE = pvp_color_s.getProperty("TitleForAmount5", "Veteran");
				PVP_AMOUNT6 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount6", "390"));
				TITLE_COLOR_FOR_PVP_AMOUNT6 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount6", "00FF00"));
				PVP6_TITLE = pvp_color_s.getProperty("TitleForAmount6", "Champion");
				PVP_AMOUNT7 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount7", "500"));
				TITLE_COLOR_FOR_PVP_AMOUNT7 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount7", "00FF00"));
				PVP7_TITLE = pvp_color_s.getProperty("TitleForAmount7", "Commander");
				PVP_AMOUNT8 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount8", "650"));
				TITLE_COLOR_FOR_PVP_AMOUNT8 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount8", "00FF00"));
				PVP8_TITLE = pvp_color_s.getProperty("TitleForAmount8", "Master");
				PVP_AMOUNT9 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount9", "800"));
				TITLE_COLOR_FOR_PVP_AMOUNT9 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount9", "00FF00"));
				PVP9_TITLE = pvp_color_s.getProperty("TitleForAmount9", "Assassin");
				PVP_AMOUNT10 = Integer.parseInt(pvp_color_s.getProperty("PvpAmount10", "1000"));
				TITLE_COLOR_FOR_PVP_AMOUNT10 = Integer.decode("0x" + pvp_color_s.getProperty("ColorForAmount10", "00FF00"));
				PVP10_TITLE = pvp_color_s.getProperty("TitleForAmount10", "Hero");
			}
			catch (Exception e)
			{
				_log.warning("Config: " + e.getMessage());
				throw new Error("Failed to Load " + PVP_COLOR_SYSTEM + " File.");
			}
			...
			try (InputStream is = new FileInputStream(antharas))
			{
				...
				Interval_Of_Antharas_Spawn = Integer.parseInt(antharas_load.getProperty("IntervalOfAntharasSpawn", "264"));
				...
				Random_Of_Antharas_Spawn = Integer.parseInt(antharas_load.getProperty("RandomOfAntharasSpawn", "72"));
			...
			try (InputStream is = new FileInputStream(valakas))
			{
				...
				Interval_Of_Valakas_Spawn = Integer.parseInt(valakas_load.getProperty("IntervalOfValakasSpawn", "264"));
				...
				Random_Of_Valakas_Spawn = Integer.parseInt(valakas_load.getProperty("RandomOfValakasSpawn", "72"));
			...
			try (InputStream is = new FileInputStream(baium))
			{
				...
				baium_load.load(is);
				Interval_Of_Baium_Spawn = Integer.parseInt(baium_load.getProperty("IntervalOfBaiumSpawn", "168"));
				...
				Random_Of_Baium_Spawn = Integer.parseInt(baium_load.getProperty("RandomOfBaiumSpawn", "48"));
			...
			try (InputStream is = new FileInputStream(core))
			{
				...
				core_load.load(is);
				Interval_Of_Core_Spawn = Integer.parseInt(core_load.getProperty("IntervalOfCoreSpawn", "60"));
				...
				Random_Of_Core_Spawn = Integer.parseInt(core_load.getProperty("RandomOfCoreSpawn", "24"));
			...
			try (InputStream is = new FileInputStream(orfen))
			{
				...
				orfen_load.load(is);
				Interval_Of_Orfen_Spawn = Integer.parseInt(orfen_load.getProperty("IntervalOfOrfenSpawn", "48"));
				...
				Random_Of_Orfen_Spawn = Integer.parseInt(orfen_load.getProperty("RandomOfOrfenSpawn", "20"));
			...
			try (InputStream is = new FileInputStream(queen))
			{
				...
				queen_load.load(is);
				Interval_Of_QueenAnt_Spawn = Integer.parseInt(queen_load.getProperty("IntervalOfQueenAntSpawn", "36"));
				...
				Random_Of_QueenAnt_Spawn = Integer.parseInt(queen_load.getProperty("RandomOfQueenAntSpawn", "17"));
			...
			try (InputStream is = new FileInputStream(beleth))
			{
				...
				beleth_load.load(is);
				INTERVAL_OF_BELETH_SPAWN = Integer.parseInt(beleth_load.getProperty("IntervalOfBelethSpawn", "192"));
				...
				RANDOM_OF_BELETH_SPAWN = Integer.parseInt(beleth_load.getProperty("RandomOfBelethSpawn", "148"));
			...
			// Load L2PSMod L2Properties file (if exists)
			L2Properties L2PsMods = new L2Properties();
			final File l2jmods = new File(PSMODS_CONFIG_FILE);
			...
			String PVP_SKILLS_LIST_VALUE = L2PsMods.getProperty("PvPSkillsList", "100,3100;");
			...
			NEWBIE_WELCOME_ENABLE = Boolean.parseBoolean(L2PsMods.getProperty("NewbieWelcomeMessage", "False"));
			LIMIT_SUMMONS_PAILAKA = Boolean.parseBoolean(L2PsMods.getProperty("PailakaLimitSummon", "False"));
			ENABLE_WAREHOUSESORTING_CLAN = Boolean.parseBoolean(L2PsMods.getProperty("EnableWarehouseSortingClan", "False"));
			...
			WELCOME_MESSAGE_TIME = Integer.parseInt(L2PsMods.getProperty("ScreenWelcomeMessageTime", "10")) * 1000;
			ANTIFEED_ENABLE = Boolean.parseBoolean(L2PsMods.getProperty("AntiFeedEnable", "false"));
			ANTIFEED_DUALBOX = Boolean.parseBoolean(L2PsMods.getProperty("AntiFeedDualbox", "true"));
			ANTIFEED_DISCONNECTED_AS_DUALBOX = Boolean.parseBoolean(L2PsMods.getProperty("AntiFeedDisconnectedAsDualbox", "true"));
			ANTIFEED_INTERVAL = 1000 * Integer.parseInt(L2PsMods.getProperty("AntiFeedInterval", "120"));
			ANNOUNCE_PK_PVP = Boolean.parseBoolean(L2PsMods.getProperty("AnnouncePkPvP", "False"));
			ANNOUNCE_PK_PVP_NORMAL_MESSAGE = Boolean.parseBoolean(L2PsMods.getProperty("AnnouncePkPvPNormalMessage", "True"));
			ANNOUNCE_PK_MSG = L2PsMods.getProperty("AnnouncePkMsg", "$killer has slaughtered $target");
			ANNOUNCE_PVP_MSG = L2PsMods.getProperty("AnnouncePvpMsg", "$killer has defeated $target");
			MULTILANG_DEFAULT = L2PsMods.getProperty("MultiLangDefault", "en");
			MULTILANG_ENABLE = Boolean.parseBoolean(L2PsMods.getProperty("MultiLangEnable", "false"));
			String[] allowed = L2PsMods.getProperty("MultiLangAllowed", MULTILANG_DEFAULT).split(";");
			...
			MULTILANG_SM_ENABLE = Boolean.parseBoolean(L2PsMods.getProperty("MultiLangSystemMessageEnable", "False"));
			allowed = L2PsMods.getProperty("MultiLangSystemMessageAllowed", "").split(";");
			...
			MULTILANG_NS_ENABLE = Boolean.parseBoolean(L2PsMods.getProperty("MultiLangNpcStringEnable", "False"));
			allowed = L2PsMods.getProperty("MultiLangNpcStringAllowed", "").split(";");
			...
			L2WALKER_PROTECTION = Boolean.parseBoolean(L2PsMods.getProperty("L2WalkerProtection", "False"));
			DUALBOX_CHECK_MAX_PLAYERS_PER_IP = Integer.parseInt(L2PsMods.getProperty("DualboxCheckMaxPlayersPerIP", "0"));
			DUALBOX_CHECK_MAX_OLYMPIAD_PARTICIPANTS_PER_IP = Integer.parseInt(L2PsMods.getProperty("DualboxCheckMaxOlympiadParticipantsPerIP", "0"));
			DUALBOX_CHECK_MAX_L2EVENT_PARTICIPANTS_PER_IP = Integer.parseInt(L2PsMods.getProperty("DualboxCheckMaxL2EventParticipantsPerIP", "0"));
			String[] dualboxCheckWhiteList = L2PsMods.getProperty("DualboxCheckWhitelist", "127.0.0.1,0").split(";");
