 ...
 * Author: RobikBobik
 */
public class SpawnTableData extends DocumentParser
{
	private static Logger _log = Logger.getLogger(SpawnTableData.class.getName());
	
	private final FastSet<L2Spawn> _spawntable = new FastSet<>();
	protected int _npcSpawnCount;
	
	protected SpawnTableData()
	{
	...
	public static SpawnTableData getInstance()
	{
	...
	{
		protected static final SpawnTableData _instance = new SpawnTableData();
	}
}