...
public final class L2PcInstance extends L2Playable
{
	...
	public boolean doDie(L2Character killer)
	{
		...
		if (killer != null)
		{
			...
			// Rank Arena
			if (Config.RANK_ARENA_ENABLED && (killer instanceof L2PcInstance) && isInsideZone(ZoneId.PVP) && !isInSiege())
			{
				if (!killer.isGM() && !isGM())
				{
					LeaderboardArena.getInstance().onKill(killer.getObjectId(), killer.getName());
	...
	public void increasePvpKills(L2Character target)
	{
		if ((target instanceof L2PcInstance) && AntiFeedManager.getInstance().check(this, target))
		{
			...
			if (Config.PVP_SYSTEM_QUAKE)
			{
				...
				{
					case 4:
						Announcements.getInstance().announceToAll("" + this.getName() + " is Dominating! without die!", true);
						break;
					
					case 6:
						Announcements.getInstance().announceToAll("" + this.getName() + " is on a Rampage! without die!", true);
						break;
					
					case 8:
						Announcements.getInstance().announceToAll("" + this.getName() + " is on a Killing Spree! without die!", true);
						break;
					
					case 10:
						Announcements.getInstance().announceToAll("" + this.getName() + " is on a Monster Kill! without die!", true);
						break;
					
					case 12:
						Announcements.getInstance().announceToAll("" + this.getName() + " is Unstoppable! without die!", true);
						break;
					
					case 14:
						Announcements.getInstance().announceToAll("" + this.getName() + " is on an Ultra Kill! without die!", true);
						break;
					
					case 16:
						Announcements.getInstance().announceToAll("" + this.getName() + " is Godlike without die!", true);
						break;
					
					case 18:
						Announcements.getInstance().announceToAll("" + this.getName() + " is Wicked Sick! without die!", true);
						break;
					
					case 20:
						Announcements.getInstance().announceToAll("" + this.getName() + " is on a Ludricrous Kill! without die!", true);
						break;
					
					case 22:
						Announcements.getInstance().announceToAll("" + this.getName() + " is Rambo - 22 Kills without die!", true);
						break;
					
					case 24:
						Announcements.getInstance().announceToAll("" + this.getName() + " is Terminator - 24 Kills Good! without die!", true);
						break;
					
					case 26:
						Announcements.getInstance().announceToAll("" + this.getName() + " is Neo from Matrix - 26 Kills Better!! without die!", true);
						break;
					
					case 28:
						Announcements.getInstance().announceToAll("" + this.getName() + " is on a Holy Sh!t! - 28 Kills Nice!!! without die!", true);
						break;
					
					case 30:
						Announcements.getInstance().announceToAll("" + this.getName() + " Sh!t !! this can only GM, ban him !! - 30 Kills WAU!!!!  without die!", true);
						break;
				}
			}
	...
	public void increasePkKillsAndKarma(L2Character target)
	{
		...
		if (Config.PK_SYSTEM_QUAKE)
		{
			...
			{
				case 4:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 4 PKs without die!", true);
					break;
				
				case 6:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 6 PKs without die!", true);
					break;
				
				case 8:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 8 PKs without die!", true);
					break;
				
				case 10:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 10 PKs without die!", true);
					break;
				
				case 12:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 12 PKs without die!", true);
					break;
				
				case 14:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 14 PKs without die!", true);
					break;
				
				case 16:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 16 PKs without die!", true);
					break;
				
				case 18:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 18 PKs without die!", true);
					break;
				
				case 20:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 20 PKs without die!", true);
					break;
				
				case 22:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 22 PKs without die!", true);
					break;
				
				case 24:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 24 PKs without die!", true);
					break;
				
				case 26:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 26 PKs without die!", true);
					break;
				
				case 28:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 28 PKs without die!", true);
					break;
				
				case 30:
					Announcements.getInstance().announceToAll("This player " + this.getName() + " reached 30 PKs without die!", true);
					break;
			}
		}
	...
	{
		TerritoryWarManager tw = TerritoryWarManager.getInstance();
		if (tw.isTWInProgress())
		{
			int pltw = tw.getRegisteredTerritoryId(this);
			int tgtw = tw.getRegisteredTerritoryId(target);
			if ((pltw > 0) && (tgtw > 0) && (pltw == tgtw))
			{
				return true;
			}
		}
