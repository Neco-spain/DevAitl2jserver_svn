...
public class _1_HotSpringDisease extends AbstractNpcAI
{
	...
	public _1_HotSpringDisease(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_HotSpringDisease(-1, "HotSpringDisease", "data");
	}
}
