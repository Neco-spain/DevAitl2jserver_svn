...
public class _4_PailakaSongOfIceAndFire extends Quest
{
	...
	public _4_PailakaSongOfIceAndFire(int questId, String name, String descr)
	{
	...
	{
		new _4_PailakaSongOfIceAndFire(128, qn, "Pailaka - Song of Ice and Fire");
	}
}