...
public class _1_SelMahumDrill extends AbstractNpcAI
{
	...
	public _1_SelMahumDrill(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_SelMahumDrill(_1_SelMahumDrill.class.getSimpleName(), "data");
	}
}