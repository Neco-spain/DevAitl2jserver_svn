 ...
 * @author Gigiikun
 */
public class _1_EnergySeeds extends AbstractNpcAI
{
	...
	private _1_EnergySeeds(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_EnergySeeds(_1_EnergySeeds.class.getSimpleName(), "data");
	}
}