...
public class _1_VarkaKetraAlly extends AbstractNpcAI
{
	public _1_VarkaKetraAlly(int questId, String name, String descr)
	{
		super(name, descr);
		int[] mobs =
		{
	...
	{
		new _1_VarkaKetraAlly(-1, "Varka Ketra Ally", "data");
	}
}