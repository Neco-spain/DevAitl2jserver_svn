...
public class _4_ChamberOfDelusionWest extends Quest
{
	...
	public _4_ChamberOfDelusionWest(int questId, String name, String descr)
	{
	...
	{
		new _4_ChamberOfDelusionWest(-1, qn, "instances");
	}
}