...
public class _0_TurekOrcSupplier extends AbstractNpcAI
{
	private static final int TUREK_ORC_SUPPLIER = 20498;
	
	public _0_TurekOrcSupplier(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_TurekOrcSupplier(-1, "TurekOrcSupplier", "data");
	}
}