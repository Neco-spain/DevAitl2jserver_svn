...
public class _4_ChamberOfDelusionSout extends Quest
{
	...
	public _4_ChamberOfDelusionSout(int questId, String name, String descr)
	{
	...
	{
		new _4_ChamberOfDelusionSout(-1, qn, "instances");
	}
}