 ...
 */
public class Q00311_ExpulsionOfEvilSpirits extends QuestJython
{
	...
	private Q00311_ExpulsionOfEvilSpirits(int questId, String name, String descr)
	{
	...
	{
		QuestState qs = player.getQuestState(getName());
		String htmltext = "<html><body>There no quest for you. Come back later.</body></html>";
