...
public class _1_PlainsOfDion extends AbstractNpcAI
{
	...
	public _1_PlainsOfDion(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_PlainsOfDion(_1_PlainsOfDion.class.getSimpleName(), "data");
	}
}