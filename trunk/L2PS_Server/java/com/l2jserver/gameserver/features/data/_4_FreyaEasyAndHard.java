...
import com.l2jserver.gameserver.network.serverpackets.Scenkos;
 ...
 */
public class _4_FreyaEasyAndHard extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (event.equalsIgnoreCase("hard") && (npc.getNpcId() == Superior_Knight))
		{
			...
			_isHard = true;
			enterInstance(player, "FreyaEasyAndHard.xml");
		}
	...
	{
		new _4_FreyaEasyAndHard(-1, qn, "instances");
	}
}