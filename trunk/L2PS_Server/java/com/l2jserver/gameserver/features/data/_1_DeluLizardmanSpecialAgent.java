...
public class _1_DeluLizardmanSpecialAgent extends AbstractNpcAI
{
	private static final int DELU_LIZARDMAN_SPECIAL_AGENT = 21105;
	
	public _1_DeluLizardmanSpecialAgent(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_DeluLizardmanSpecialAgent(-1, "DeluLizardmanSpecialAgent", "data");
	}
}