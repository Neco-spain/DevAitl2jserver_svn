...
/*
 * Autor: RobikBobik (L2Brick) now L2PS
 */
public class _0_FireDragonMinions extends AbstractNpcAI
{
	...
	public _0_FireDragonMinions(int id, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_FireDragonMinions(-1, "FireDragonMinions", "data");
	}
}
