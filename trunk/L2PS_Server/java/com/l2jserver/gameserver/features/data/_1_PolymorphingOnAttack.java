 ...
 * @author Slyce
 */
public class _1_PolymorphingOnAttack extends AbstractNpcAI
{
	...
	private _1_PolymorphingOnAttack(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_PolymorphingOnAttack(_1_PolymorphingOnAttack.class.getSimpleName(), "data");
	}
}
