...
public class _1_CryptsOfDisgrace extends AbstractNpcAI
{
	...
	public _1_CryptsOfDisgrace(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_CryptsOfDisgrace(-1, "CryptsOfDisgrace", "data");
	}
}