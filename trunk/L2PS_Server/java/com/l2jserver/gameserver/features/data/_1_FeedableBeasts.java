 ...
 * @author Fulminus
 */
public class _1_FeedableBeasts extends AbstractNpcAI
{
	...
	private _1_FeedableBeasts(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_FeedableBeasts(_1_FeedableBeasts.class.getSimpleName(), "data");
	}
}
