...
/**
 * TODO: 1. Kechi's Henchmans spawn animation is missing. 2. NPC related Traps are not supported by core, so Darnels and Lahm door trap is not working. 4. Baylor Raid is missing a lot of things
 */
public class _4_CrystalCaverns extends Quest
{
	...
	public _4_CrystalCaverns(int questId, String name, String descr)
	{
	...
	public static void main(String[] args)
	{
		...
		new _4_CrystalCaverns(-1, qn, "instances");
	}
}