 ...
 */
public final class Q00134_TempleMissionary extends Quest
{
	...
	public Q00134_TempleMissionary(int questId, String name, String descr)
	{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if (st.getCond() == 3)
		{
			if (npc.getNpcId() == MARSHLANDS_TRAITOR)
			{
