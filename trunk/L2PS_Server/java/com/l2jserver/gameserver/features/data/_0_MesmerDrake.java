 ...
 * @author Adry_85
 */
public class _0_MesmerDrake extends AbstractNpcAI
{
	...
	private _0_MesmerDrake(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_MesmerDrake(_0_MesmerDrake.class.getSimpleName(), "data");
	}
}
