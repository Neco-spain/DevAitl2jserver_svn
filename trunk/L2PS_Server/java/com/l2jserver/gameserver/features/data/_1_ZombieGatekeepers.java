...
public class _1_ZombieGatekeepers extends AbstractNpcAI
{
	public _1_ZombieGatekeepers(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_ZombieGatekeepers(-1, "ZombieGatekeepers", "data");
	}
}