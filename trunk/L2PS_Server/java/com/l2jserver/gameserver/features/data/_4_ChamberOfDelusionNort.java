...
public class _4_ChamberOfDelusionNort extends Quest
{
	...
	public _4_ChamberOfDelusionNort(int questId, String name, String descr)
	{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if ((rb == 0) && (npcId == AENKINEL))
		{
			...
			if (tmpworld instanceof CDWorld)
			{
				...
				world.chestb = addSpawn(FAIL1, spawn2, -155070, -6752, 0, false, 0, false, world.instanceId);
				world.chestb.setIsNoRndWalk(true);
				world.chestc = addSpawn(FAIL2, spawn3, -155071, -6752, 0, false, 0, false, world.instanceId);
				world.chestc.setIsNoRndWalk(true);
				world.chestd = addSpawn(FAIL3, spawn4, -155070, -6752, 0, false, 0, false, world.instanceId);
	...
	{
		new _4_ChamberOfDelusionNort(-1, qn, "instances");
	}
}