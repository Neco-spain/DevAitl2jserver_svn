 ...
 * @author Gnacik
 */
public class _1_GiantScouts extends AbstractNpcAI
{
	...
	private _1_GiantScouts(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_GiantScouts(_1_GiantScouts.class.getSimpleName(), "data");
	}
}