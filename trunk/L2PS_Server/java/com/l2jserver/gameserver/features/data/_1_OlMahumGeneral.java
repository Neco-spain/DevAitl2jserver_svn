...
public class _1_OlMahumGeneral extends AbstractNpcAI
{
	private static final int Ol_Mahum_General = 20438;
	private static boolean _FirstAttacked;
	
	public _1_OlMahumGeneral(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_OlMahumGeneral(-1, "OlMahumGeneral", "data");
	}
}