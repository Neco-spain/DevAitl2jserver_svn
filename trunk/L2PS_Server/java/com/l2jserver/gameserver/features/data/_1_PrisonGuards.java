 ...
 * @author Gigiikun
 */
public class _1_PrisonGuards extends AbstractNpcAI
{
	...
	private _1_PrisonGuards(String name, String descr)
	{
		super(name, descr);
		int[] mob =
		{
	...
	public String onAttack(L2Npc npc, L2PcInstance player, int damage, boolean isPet)
	{
		...
		{
			final QuestState qs = player.getQuestState(_3_IOPRace.class.getSimpleName());
	...
	{
		new _1_PrisonGuards(_1_PrisonGuards.class.getSimpleName(), "data");
	}
}
