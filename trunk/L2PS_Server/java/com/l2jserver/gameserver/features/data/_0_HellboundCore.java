 ...
 * @author GKR
 */
public class _0_HellboundCore extends AbstractNpcAI
{
	...
	private _0_HellboundCore(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_HellboundCore(_0_HellboundCore.class.getSimpleName(), "data");
	}
}
