...
public class _1_NecromancerOfTheValley extends AbstractNpcAI
{
	public _1_NecromancerOfTheValley(int questId, String name, String descr)
	{
		super(name, descr);
		addKillId(22858);
	}
	...
	{
		new _1_NecromancerOfTheValley(-1, "NecromancerOfTheValley", "data");
	}
}