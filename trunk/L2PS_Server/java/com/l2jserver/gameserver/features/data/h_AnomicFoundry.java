 ...
 * @author GKR
 */
public class h_AnomicFoundry extends Quest
{
	...
	public h_AnomicFoundry(int questId, String name, String descr)
	{
	...
	{
		new h_AnomicFoundry(-1, h_AnomicFoundry.class.getSimpleName(), "hellbound");
	}
}
