...
public class Q00373_SupplierOfReagents extends Quest
{
	...
	public Q00373_SupplierOfReagents(int id, String name, String descr)
	{
		super(id, name, descr);
		...
		else
		{
			...
			for (Object[] ITEM : ITEMS)
			{
				...
				if (((item >= 6011) && (item <= 6031)) || ((item >= 6320) && (item <= 6321)))
				{
					...
					{
						amt += 1;
						html += "<tr><td height=45><img src=icon." + ITEM[1] + " height=32 width=32></td><td width=180>" + ITEM[2] + "</td><td><button value=X1 action=\"bypass -h Quest Q00373_SupplierOfReagents x_1_" + page[1] + "_" + item + "\" width=40 height=15 fore=sek.cbui92><button value=X10 action=\"bypass -h Quest Q00373_SupplierOfReagents x_2_" + page[1] + "_" + item + "\" width=40 height=15 fore=sek.cbui92></td></tr>";
					}
				}
			}
			if (amt == 0)
