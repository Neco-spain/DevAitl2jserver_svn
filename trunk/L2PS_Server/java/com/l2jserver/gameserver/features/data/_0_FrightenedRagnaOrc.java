...
public class _0_FrightenedRagnaOrc extends AbstractNpcAI
{
	// NPC ID
	...
	public _0_FrightenedRagnaOrc(String name, String descr)
	{
		super(name, descr);
		addAttackId(MOB_ID);
		addKillId(MOB_ID);
	...
	{
		new _0_FrightenedRagnaOrc(_0_FrightenedRagnaOrc.class.getSimpleName(), "data");
	}
}