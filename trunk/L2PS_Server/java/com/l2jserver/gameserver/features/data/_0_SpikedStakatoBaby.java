...
public class _0_SpikedStakatoBaby extends AbstractNpcAI
{
	private static final int SPIKED_STAKATO_NURSE = 22630;
	private static final int SPIKED_STAKATO_CAPTAIN = 22629;
	
	public _0_SpikedStakatoBaby(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_SpikedStakatoBaby(-1, "SpikedStakatoBaby", "data");
	}
}