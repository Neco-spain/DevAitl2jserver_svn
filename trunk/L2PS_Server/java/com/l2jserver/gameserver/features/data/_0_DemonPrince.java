 ...
 * @author GKR
 */
public class _0_DemonPrince extends AbstractNpcAI
{
	...
	private _0_DemonPrince(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_DemonPrince(_0_DemonPrince.class.getSimpleName(), "data");
	}
}
