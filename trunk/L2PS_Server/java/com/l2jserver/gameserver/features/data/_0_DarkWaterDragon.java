 ...
 */
public class _0_DarkWaterDragon extends AbstractNpcAI
{
	...
	private _0_DarkWaterDragon(String name, String descr)
	{
		super(name, descr);
		int[] mobs =
		{
	...
	{
		new _0_DarkWaterDragon(_0_DarkWaterDragon.class.getSimpleName(), "data");
	}
}
