 ...
 * @author Charus
 */
public class _1_FairyTrees extends AbstractNpcAI
{
	...
	private _1_FairyTrees(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_FairyTrees(_1_FairyTrees.class.getSimpleName(), "data");
	}
}
