...
public class Q00615_MagicalPowerOfFirePart1 extends Quest
{
	...
	public Q00615_MagicalPowerOfFirePart1(int questId, String name, String descr)
	{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.UDAN_HAS_ALREADY_SEEN_YOUR_FACE));
			return null;
		}
		return htmltext;
	}
	...
	public String onAggroRangeEnter(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if ((st.getInt("spawned") == 0) && (st.getInt("cond") == 2))
		{
			...
			if (udanEye != null)
			{
				...
				udanEye.broadcastPacket(new NpcSay(udanEye.getObjectId(), 0, udanEye.getNpcId(), NpcStringId.YOU_CANT_AVOID_THE_EYES_OF_UDAN));
