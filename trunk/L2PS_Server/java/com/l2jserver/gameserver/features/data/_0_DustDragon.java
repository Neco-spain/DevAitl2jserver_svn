 ...
 * @author Adry_85
 */
public class _0_DustDragon extends AbstractNpcAI
{
	...
	private _0_DustDragon(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _0_DustDragon(_0_DustDragon.class.getSimpleName(), "data");
	}
}
