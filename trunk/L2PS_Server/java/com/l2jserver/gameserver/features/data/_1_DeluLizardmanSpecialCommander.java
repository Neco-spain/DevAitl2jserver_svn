...
public class _1_DeluLizardmanSpecialCommander extends AbstractNpcAI
{
	private static final int DELU_LIZARDMAN_SPECIAL_COMMANDER = 21107;
	
	public _1_DeluLizardmanSpecialCommander(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_DeluLizardmanSpecialCommander(-1, "DeluLizardmanSpecialCommander", "data");
	}
}
