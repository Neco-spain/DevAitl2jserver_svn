 ...
 * @author Gigiikun
 */
public class _1_StarStones extends AbstractNpcAI
{
	...
	private _1_StarStones(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_StarStones(_1_StarStones.class.getSimpleName(), "data");
	}
}
