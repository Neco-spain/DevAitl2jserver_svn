...
public class Q00621_EggDelivery extends Quest
{
	...
	private final int[] NPCS = new int[]
	{
		PULIN,
		NAFF,
		CROCUS,
	...
	public Q00621_EggDelivery(int questId, String name, String descr)
	{
		super(questId, name, descr);
		
		addStartNpc(JEREMY);
		
		for (int element : NPCS)
		{
			addTalkId(element);
		}
	...
	{
		new Q00621_EggDelivery(621, Q00621_EggDelivery.class.getSimpleName(), "Egg Delivery");
	}
}