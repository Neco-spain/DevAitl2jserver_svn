 ...
 */
public final class _1_PlainsOfLizardman extends AbstractNpcAI
{
	// NPCs
	...
	private _1_PlainsOfLizardman(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_PlainsOfLizardman(_1_PlainsOfLizardman.class.getSimpleName(), "ai");
	}
}