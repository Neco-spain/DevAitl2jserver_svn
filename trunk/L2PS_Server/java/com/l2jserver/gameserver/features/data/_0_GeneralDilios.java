 ...
 */
public class _0_GeneralDilios extends AbstractNpcAI
{
	...
	private _0_GeneralDilios(String name, String descr)
	{
		super(name, descr);
		findNpcs();
	...
	{
		new _0_GeneralDilios(_0_GeneralDilios.class.getSimpleName(), "data");
	}
}
