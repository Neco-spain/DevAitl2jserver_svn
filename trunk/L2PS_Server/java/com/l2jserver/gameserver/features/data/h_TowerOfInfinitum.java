 ...
 * @author GKR
 */
public class h_TowerOfInfinitum extends Quest
{
	...
	public h_TowerOfInfinitum(int questId, String name, String descr)
	{
	...
	{
		new h_TowerOfInfinitum(-1, h_TowerOfInfinitum.class.getSimpleName(), "hellbound");
	}
}
