 ...
 * @author Gnacik
 */
public class _1_StakatoNest extends AbstractNpcAI
{
	...
	private _1_StakatoNest(String name, String descr)
	{
		super(name, descr);
	...
	{
		new _1_StakatoNest(_1_StakatoNest.class.getSimpleName(), "data");
	}
}
