...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.NEWBIE_WELCOME_ENABLE && (activeChar.getLevel() == 1))
		{
			...
			{
				case DarkElf:
					CreatureSay Newbie = new CreatureSay(0, Say2.CRITICAL_ANNOUNCE, "", "" + "Welcome Dark Elf, you are the bloodiest ever.");
					activeChar.sendPacket(Newbie);
					break;
				case Dwarf:
					CreatureSay Newbie1 = new CreatureSay(0, Say2.CRITICAL_ANNOUNCE, "", "" + "Welcome Dwarf, you are like Dani De Vito.");
					activeChar.sendPacket(Newbie1);
					break;
				case Elf:
					CreatureSay Newbie2 = new CreatureSay(0, Say2.CRITICAL_ANNOUNCE, "", "" + "Welcome Elf, your class skin color is like Andres Iniesta.");
					activeChar.sendPacket(Newbie2);
					break;
				case Kamael:
					CreatureSay Newbie3 = new CreatureSay(0, Say2.CRITICAL_ANNOUNCE, "", "" + "Welcome Kamael, dont lose your wing.");
					activeChar.sendPacket(Newbie3);
					break;
				case Orc:
					CreatureSay Newbie4 = new CreatureSay(0, Say2.CRITICAL_ANNOUNCE, "", "" + "Welcome Orc, you are the most brutal class in Lineage II.");
					activeChar.sendPacket(Newbie4);
					break;
				case Human:
					CreatureSay Newbie5 = new CreatureSay(0, Say2.CRITICAL_ANNOUNCE, "", "" + "Welcome Human, you have choosen the most balanced class.");
					activeChar.sendPacket(Newbie5);
					break;
			}
		}
