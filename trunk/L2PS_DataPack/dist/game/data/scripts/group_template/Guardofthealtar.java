...
public class Guardofthealtar extends AbstractNpcAI
{
	private static final int GUARD_OF_THE_ALTAR = 18811;
	private static final int DARK_SHAMAN_VARANGKA = 18808;

	public Guardofthealtar(int questId, String name, String descr)
	{
		super(name, descr);
	...
	{
		new Guardofthealtar(-1, "Guard of the altar", "group_template");
	}
}