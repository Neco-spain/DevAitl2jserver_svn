...
public class Tyrannosaurus extends AbstractNpcAI
{
	...
	public String onSkillSee(L2Npc npc, L2PcInstance player, L2Skill skill, L2Object[] targets, boolean isPet)
	{
		...
		for (final L2Object trg : targets)
			if (trg == npc)
				b = true;
		if (!b) return super.onSkillSee(npc, player, skill, targets, isPet);
	...
	{
		new Tyrannosaurus(-1,"Tyrannosaurus","group_template");
	}
}