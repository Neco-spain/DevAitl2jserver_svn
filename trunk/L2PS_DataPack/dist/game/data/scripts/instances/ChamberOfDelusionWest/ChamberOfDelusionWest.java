...
public class ChamberOfDelusionWest extends Quest
{
	...
	protected void spawnState(CDWorld world)
	{
		...
		world.manager = addSpawn(32665, -121440, -154688, -6752, 0, false, 0, false, world.getInstanceId());
		world.manager.setIsNoRndWalk(true);
		world.managerb = addSpawn(32665, -122368, -153504, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerb.setIsNoRndWalk(true);
		world.managerc = addSpawn(32665, -120496, -154304, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerc.setIsNoRndWalk(true);
		world.managerd = addSpawn(32665, -120496, -155184, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerd.setIsNoRndWalk(true);
		world.managere = addSpawn(32665, -121440, -151328, -6752, 0, false, 0, false, world.getInstanceId());
		world.managere.setIsNoRndWalk(true);
		world.managerf = addSpawn(32665, -120496, -153008, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerf.setIsNoRndWalk(true);
		world.managerg = addSpawn(32665, -122368, -154800, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerg.setIsNoRndWalk(true);
		world.managerh = addSpawn(32665, -121440, -153008, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerh.setIsNoRndWalk(true);
		world.managera = addSpawn(32665, -122368, -152624, -6752, 0, false, 0, false, world.getInstanceId());
