...
public class ChamberOfDelusionGreat extends Quest
{
	...
	{
		world._aenkinel = addSpawn(AENKINEL, -108053, -155018, -6752, 0, false, 0, false, world.getInstanceId());
		world._aenkinel.setIsNoRndWalk(false);
		world.manager = addSpawn(32668, -108064, -154688, -6752, 0, false, 0, false, world.getInstanceId());
		world.manager.setIsNoRndWalk(true);
		world.managerb = addSpawn(32668, -108992, -152624, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerb.setIsNoRndWalk(true);
		world.managerc = addSpawn(32668, -108992, -153504, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerc.setIsNoRndWalk(true);
		world.managerd = addSpawn(32668, -107120, -154304, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerd.setIsNoRndWalk(true);
		world.managere = addSpawn(32668, -107120, -155184, -6752, 0, false, 0, false, world.getInstanceId());
		world.managere.setIsNoRndWalk(true);
		world.managerf = addSpawn(32668, -108064, -151328, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerf.setIsNoRndWalk(true);
		world.managerg = addSpawn(32668, -107120, -153008, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerg.setIsNoRndWalk(true);
		world.managerh = addSpawn(32668, -108992, -154800, -6752, 0, false, 0, false, world.getInstanceId());
		world.managerh.setIsNoRndWalk(true);
		world.managera = addSpawn(32668, -108064, -153008, -6752, 0, false, 0, false, world.getInstanceId());
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if (npcId == AENKINEL)
		{
			...
			if (tmpworld instanceof CDWorld)
			{
				...
				world.chesta = addSpawn(PRIZ, spawn_x, -155118, -6752, 0, false, 0, false, world.getInstanceId());
				world.chesta.setIsNoRndWalk(true);
				world.chestb = addSpawn(FAIL1, spawn2, -155118, -6752, 0, false, 0, false, world.getInstanceId());
				world.chestb.setIsNoRndWalk(true);
				world.chestc = addSpawn(FAIL2, spawn3, -155118, -6752, 0, false, 0, false, world.getInstanceId());
				world.chestc.setIsNoRndWalk(true);
				world.chestd = addSpawn(FAIL3, spawn4, -155118, -6752, 0, false, 0, false, world.getInstanceId());
	...
	{
		new ChamberOfDelusionGreat(-1, ChamberOfDelusionGreat.class.getSimpleName(), "instances");
	}
}