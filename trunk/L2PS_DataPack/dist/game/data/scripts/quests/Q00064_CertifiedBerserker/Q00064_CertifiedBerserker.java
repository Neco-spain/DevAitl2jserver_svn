...
public final class Q00064_CertifiedBerserker extends Quest
{
	...
	private static final int[] QUESTITEMS =
	{
		...
		REPORT_NORTH,
		HARKILGAMEDS_LETTER,
		TENAINS_RECOMMENDATION,
		ORKURUS_RECOMMENDATION
	};
	
	public Q00064_CertifiedBerserker(int questId, String name, String descr)
	{
	...
	{
		new Q00064_CertifiedBerserker(64, Q00064_CertifiedBerserker.class.getSimpleName(), "Certified Berserker");
	}
}