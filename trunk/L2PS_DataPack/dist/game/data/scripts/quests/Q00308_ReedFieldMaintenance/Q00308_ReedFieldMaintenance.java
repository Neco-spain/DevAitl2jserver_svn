...
public class Q00308_ReedFieldMaintenance extends Quest
{
	...
	public Q00308_ReedFieldMaintenance(int id, String name, String descr)
	{
		super(id, name, descr);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		QuestState st1 = player.getQuestState("Q00309_ForAGoodCause");
		QuestState st2 = player.getQuestState("Q00238_SuccesFailureOfBusiness");
		
		int cond = st.getInt("cond");
		
		if (npc.getNpcId() == Katensa)
		{
			if (cond == 0)
			{
				if (st1 != null)
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if (isIntInArray(npc.getNpcId(), Mucrokians))
		{
			int count = 1;
		...
		else if ((npc.getNpcId() == ContaminatedMucrokian) || (npc.getNpcId() == ChangedMucrokian))
		{
			int count = 1;
			int chance = (int) (5 * Config.RATE_QUEST_DROP);
			while (chance > 1000)
