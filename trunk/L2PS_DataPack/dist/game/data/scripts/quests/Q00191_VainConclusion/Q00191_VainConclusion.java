...
public final class Q00191_VainConclusion extends Quest
{
	...
	public Q00191_VainConclusion(int questId, String name, String descr)
	{
	...
	{
		QuestState st = player.getQuestState(getName());
		QuestState qs = player.getQuestState("Q00188_SealRemoval");
		if ((npc.getNpcId() == Dorothy) && (qs != null) && qs.isCompleted() && (st == null))
		{
