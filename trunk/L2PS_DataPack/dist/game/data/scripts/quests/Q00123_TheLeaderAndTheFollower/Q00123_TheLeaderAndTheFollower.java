...
public class Q00123_TheLeaderAndTheFollower extends Quest
{
	...
	public Q00123_TheLeaderAndTheFollower(int questId, String name, String descr)
	{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("31961-09.htm"))
		{
			...
			if (cm_apprentice.isOnline())
			{
				...
				if (apprentice != null)
				{
					QuestState apQuest = apprentice.getQuestState(getName());
					if (apQuest != null)
					{
	...
	{
		new Q00123_TheLeaderAndTheFollower(123, Q00123_TheLeaderAndTheFollower.class.getSimpleName(), "The Leader And The Follower");
	}
}