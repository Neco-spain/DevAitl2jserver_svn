...
public final class Q00501_ProofOfClanAlliance extends Quest
{
	...
	private static final String PROOF_OF_CLAN_ALLIANCE = "Q00501_ProofOfClanAlliance";
	...
	private Q00501_ProofOfClanAlliance(int questId, String name, String descr)
	{
		...
		else
		{
			if (player.isClanLeader())
			{
				...
				else if ("30759-07.htm".equals(event))
				{
					...
					if (skill == null)
					{
						_log.info("501_PoCA: Missing skill " + SKILL_POISON + ", terminating quest!");
						qs.exitQuest(true);
					}
					else
					{
			...
			else
			{
				...
				else if ("30757-05.htm".equals(event))
				{
					...
					{
						// player.doDie(npc);
						_log.info("501_PoCA: Missing skill " + SKILL_DEATH);
					}
					else
					{
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		...
		switch (npc.getNpcId())
		{
			case OEL_MAHUM_WITCH_DOCTOR:
				qs.dropQuestItems(HERB_OF_OEL_MAHUM, 1, 1, 1, false, 100000, true);
				break;
			case HARIT_LIZARDMAN_SHAMAN:
				qs.dropQuestItems(HERB_OF_HARIT, 1, 1, 1, false, 100000, true);
				break;
			case VANOR_SILENOS_SHAMAN:
				qs.dropQuestItems(HERB_OF_VANOR, 1, 1, 1, false, 100000, true);
				break;
		}
		return null;
	}
	...
	public String onTalk(L2Npc npc, L2PcInstance talker)
	{
		...
		{
			return getAlreadyCompletedMsg(talker);
		}
		...
		switch (npc.getNpcId())
		{
			...
			case KALIS:
				...
				else if (state == State.STARTED)
				{
					...
					boolean poisoned = (talker.getFirstEffect(SKILL_POISON) != null);
	...
	private static class QuestClan
	{
		...
		protected QuestClan(L2Clan clan)
		{
			_clan = clan;
	...
	{
		new Q00501_ProofOfClanAlliance(501, Q00501_ProofOfClanAlliance.class.getSimpleName(), "Proof of Clan Alliance");
	}
}