...
public class Q00275_DarkWingedSpies extends Quest
{
	...
	public Q00275_DarkWingedSpies(int questId, String name, String descr)
	{
	...
	{
		new Q00275_DarkWingedSpies(275, Q00275_DarkWingedSpies.class.getSimpleName(), "Dark Winged Spies");
	}
}