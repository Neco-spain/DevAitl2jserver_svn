...
public final class Q00065_CertifiedSoulBreaker extends Quest
{
	...
	public Q00065_CertifiedSoulBreaker(int questId, String name, String descr)
	{
	...
	public String onFirstTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if ((npc.getNpcId() == KATENAR) && (st.getInt("cond") == 12))
		{
			st.unset("angel");
	...
	{
		new Q00065_CertifiedSoulBreaker(65, Q00065_CertifiedSoulBreaker.class.getSimpleName(), "Certified Soul Breaker");
	}
}