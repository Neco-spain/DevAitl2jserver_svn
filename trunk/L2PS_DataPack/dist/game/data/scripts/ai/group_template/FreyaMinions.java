...
import com.l2jserver.gameserver.features.data.ai.AbstractNpcAI;
 ...
 */
public class FreyaMinions extends AbstractNpcAI
{
	...
	public FreyaMinions(int questId, String name, String descr)
	{
		super(name, descr);
		int[] mobs =
		{
	...
	{
		new FreyaMinions(-1, FreyaMinions.class.getSimpleName(), "ai");
	}
}