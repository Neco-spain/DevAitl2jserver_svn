...
public class PremiumBuffer extends Quest
{
	...
	private static final int NPC_ID = 957;
	
	private static final String TITLE_NAME = "Premium Buffer L2jps with enchant buffs";
	private static final boolean SCRIPT_RELOAD = false;
	private static final boolean SMART_WINDOW = Config.NpcBuffer_SmartWindow;
	private static final boolean ENABLE_VIP_BUFFER = true;
	...
	public String onFirstTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			if (!ENABLE_VIP_BUFFER || (ENABLE_VIP_BUFFER && (player.getPremiumService() == 1)))
			{
