@echo off
REM ################################
REM ## L2PS Database Installer -  ##
REM ################################
REM ## Interactive script setup -  #
REM ################################
REM Copyright (C) 2012 L2PS DataPack
...
REM 675 Mass Ave, Cambridge, MA 02139, USA.
...
:loadconfig
cls
title L2PS Installer - Reading Configuration from File...
