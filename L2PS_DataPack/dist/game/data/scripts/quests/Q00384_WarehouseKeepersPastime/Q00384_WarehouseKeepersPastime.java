...
import com.l2jserver.gameserver.eventsmanager.L2Bingo;
...
public class Q00384_WarehouseKeepersPastime extends Quest
{
	...
	public Q00384_WarehouseKeepersPastime(int id, String name, String descr)
	{
		super(id, name, descr);
	...
	public static class Bingo extends L2Bingo
	{
		...
		private final static String template_choice = "<a action=\"bypass -h Quest Q00384_WarehouseKeepersPastime choice-%n%\">%n%</a>&nbsp;&nbsp;&nbsp;&nbsp;  ";
