 ...
 */
public class Q00060_GoodWorkReward extends Quest
{
	...
	public Q00060_GoodWorkReward(int questId, String name, String descr)
	{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if ((npc.getNpcId() == PURSUER) && (st.getInt("cond") == 1))
		{
			if (Rnd.get(100) < 50)
			{
				npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.YOU_ARE_STRONG_THIS_WAS_A_MISTAKE));
				return null;
			}
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.YOU_HAVE_GOOD_LUCK_I_SHALL_RETURN));
			st.set("cond", "2");
	...
	{
		new Q00060_GoodWorkReward(60, Q00060_GoodWorkReward.class.getSimpleName(), "");
	}
}