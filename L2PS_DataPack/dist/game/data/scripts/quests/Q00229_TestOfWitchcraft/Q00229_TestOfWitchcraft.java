...
public final class Q00229_TestOfWitchcraft extends Quest
{
	...
	public Q00229_TestOfWitchcraft(int questId, String name, String descr)
	{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		else if ((npcId == ENCHANTED_STONE_GOLEM) && (80 >= Rnd.get(100)) && (cond == 2) && (st.getQuestItemsCount(ENCHANTED_GOLEM_HEARTSTONE) < 20) && (st.getQuestItemsCount(IKERS_LIST) > 0))
		{
			st.giveItems(ENCHANTED_GOLEM_HEARTSTONE, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if ((npcId == LETO_LIZARDMAN) && (50 >= Rnd.get(100)) && (cond == 2) && (st.getQuestItemsCount(LETO_LIZARDMAN_CHARM) < 20) && (st.getQuestItemsCount(IKERS_LIST) > 0))
		{
			st.giveItems(LETO_LIZARDMAN_CHARM, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if ((npcId == LETO_LIZARDMAN_ARCHER) && (50 >= Rnd.get(100)) && (cond == 2) && (st.getQuestItemsCount(LETO_LIZARDMAN_CHARM) < 20) && (st.getQuestItemsCount(IKERS_LIST) > 0))
		{
			st.giveItems(LETO_LIZARDMAN_CHARM, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if ((npcId == LETO_LIZARDMAN_SOLDIER) && (60 >= Rnd.get(100)) && (cond == 2) && (st.getQuestItemsCount(LETO_LIZARDMAN_CHARM) < 20) && (st.getQuestItemsCount(IKERS_LIST) > 0))
		{
			st.giveItems(LETO_LIZARDMAN_CHARM, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if ((npcId == LETO_LIZARDMAN_WARRIOR) && (65 >= Rnd.get(100)) && (cond == 2) && (st.getQuestItemsCount(LETO_LIZARDMAN_CHARM) < 20) && (st.getQuestItemsCount(IKERS_LIST) > 0))
		{
			st.giveItems(LETO_LIZARDMAN_CHARM, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if ((npcId == LETO_LIZARDMAN_SHAMAN) && (70 >= Rnd.get(100)) && (cond == 2) && (st.getQuestItemsCount(LETO_LIZARDMAN_CHARM) < 20) && (st.getQuestItemsCount(IKERS_LIST) > 0))
		{
			st.giveItems(LETO_LIZARDMAN_CHARM, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if ((npcId == LETO_LIZARDMAN_OVERLORD) && (70 >= Rnd.get(100)) && (cond == 2) && (st.getQuestItemsCount(LETO_LIZARDMAN_CHARM) < 20) && (st.getQuestItemsCount(IKERS_LIST) > 0))
		{
			st.giveItems(LETO_LIZARDMAN_CHARM, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		...
		else if ((npcId == TAMLIN_ORC) && (50 >= Rnd.get(100)) && (cond == 6) && (st.getQuestItemsCount(TAMLIN_ORC_AMULET) < 20) && (st.getQuestItemsCount(VADINS_CRUCIFIX) > 0))
		{
			st.giveItems(TAMLIN_ORC_AMULET, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if ((npcId == TAMLIN_ORC_ARCHER) && (55 >= Rnd.get(100)) && (cond == 6) && (st.getQuestItemsCount(TAMLIN_ORC_AMULET) < 20) && (st.getQuestItemsCount(VADINS_CRUCIFIX) > 0))
		{
			st.giveItems(TAMLIN_ORC_AMULET, 1);
			st.playSound("ItemSound.quest_itemget");
		}
	...
	{
		new Q00229_TestOfWitchcraft(229, Q00229_TestOfWitchcraft.class.getSimpleName(), "Test Of Witchcraft");
	}
}