...
public class Q00062_PathoftheTrooper extends Quest
{
	...
	public Q00062_PathoftheTrooper(int questId, String name, String descr)
	{
	...
	{
		new Q00062_PathoftheTrooper(62, Q00062_PathoftheTrooper.class.getSimpleName(), "Path of the Trooper");
	}
}