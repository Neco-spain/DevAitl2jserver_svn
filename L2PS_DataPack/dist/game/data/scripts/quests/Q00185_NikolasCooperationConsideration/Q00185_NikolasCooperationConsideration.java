 ...
 */
package quests.Q00185_NikolasCooperationConsideration;
 ...
 */
public final class Q00185_NikolasCooperationConsideration extends Quest
{
	...
	private static int Metal = 10363;
	private static int BrokenMetal = 10364;
	private static int NicolasMap = 10365;
	
	public Q00185_NikolasCooperationConsideration(int questId, String name, String descr)
	{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("32366-02.htm"))
		{
			...
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.INTRUDER_ALERT_THE_ALARM_WILL_SELF_DESTRUCT_IN_2_MINUTES));
		}
		...
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.THE_ALARM_WILL_SELF_DESTRUCT_IN_60_SECONDS_ENTER_PASSCODE_TO_OVERRIDE));
			startQuestTimer("2", 30000, npc, player);
			return null;
		}
		else if (event.equalsIgnoreCase("2"))
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.THE_ALARM_WILL_SELF_DESTRUCT_IN_30_SECONDS_ENTER_PASSCODE_TO_OVERRIDE));
			startQuestTimer("3", 20000, npc, player);
			return null;
		}
		else if (event.equalsIgnoreCase("3"))
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.THE_ALARM_WILL_SELF_DESTRUCT_IN_10_SECONDS_ENTER_PASSCODE_TO_OVERRIDE));
			startQuestTimer("4", 10000, npc, player);
			return null;
		}
		else if (event.equalsIgnoreCase("4"))
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.RECORDER_CRUSHED));
			npc.deleteMe();
			st.set("step", "2");
			return null;
		}
	...
	{
		new Q00185_NikolasCooperationConsideration(185, Q00185_NikolasCooperationConsideration.class.getSimpleName(), "Nikolas Cooperation Consideration");
	}
}