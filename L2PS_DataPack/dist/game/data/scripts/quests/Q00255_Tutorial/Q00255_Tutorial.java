 ...
 */
public final class Q00255_Tutorial extends Quest
{
	...
	public Q00255_Tutorial(int questId, String name, String descr)
	{
			...
			else
			{
				switch (playerLevel)
				{
					case 18:
						...
						break;
					case 28:
						if (((player.getQuestState("Q10277_MutatedKaneusDion") == null) || (player.getQuestState("Q10278_MutatedKaneusHeine") == null)) || (player.getQuestState("Q10279_MutatedKaneusOren") == null) || (player.getQuestState("Q10280_MutatedKaneusSchuttgart") == null) || (player.getQuestState("Q10281_MutatedKaneusRune") == null))
						{
							st.showQuestionMark(33);
							st.playSound("ItemSound.quest_tutorial");
						}
	...
	{
		new Q00255_Tutorial(255, Q00255_Tutorial.class.getSimpleName(), "Q00255_Tutorial");
	}
}