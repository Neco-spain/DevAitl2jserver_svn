...
public final class Q00066_CertifiedArbalester extends Quest
{
	...
	private static final int[] _talkNpc =
	{
		RINDY,
		CLAYTON,
		POITAN,
	...
	private static final int[] _TimakMobs =
	{
		20584,
		20585
	};
	...
	private static final int[] QUESTITEMS =
	{
		...
		MANUSCRIPT_PAGE,
		ENCODED_PAGE,
		KAMAEL_INQUISITOR_TRAIN_MARK,
		FRAGMENT_ATTACK_ORDERS,
		GRANDIS_ATTACK_ORDERS,
		MANASHENS_TALISMAN,
		RESEARCH_OF_THE_GIANTS
	};
	
	public Q00066_CertifiedArbalester(int questId, String name, String descr)
	{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		else if (Util.contains(_FloranMobs, npc.getNpcId()))
		{
		...
		else if (Util.contains(_EgMobs, npc.getNpcId()))
		{
		...
		else if (Util.contains(_TimakMobs, npc.getNpcId()))
		{
	...
	{
		new Q00066_CertifiedArbalester(66, Q00066_CertifiedArbalester.class.getCanonicalName(), "Certified Arbalester");
	}
}