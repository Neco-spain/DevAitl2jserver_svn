 ...
 * Author: RobikBobik
 */
public class ReedFields extends AbstractNpcAI
{
	...
	public ReedFields(String name, String descr)
	{
		super(name, descr);
	...
	public String onAggroRangeEnter(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), NpcStringId.NAIA_WAGANAGEL_PEUTAGUN));
	...
	public String onAttack(L2Npc npc, L2PcInstance player, int damage, boolean isSummon)
	{
		...
		if (!myTrackingSet.contains(Integer.valueOf(npc.getObjectId())))
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), 0, npc.getNpcId(), MOBSTEXT.get(Integer.valueOf(npc.getNpcId()))));
			myTrackingSet.add(Integer.valueOf(npc.getObjectId()));
		}
		...
		for (L2Object obj : objs)
		{
			if (obj != null)
			{
				if (obj instanceof L2MonsterInstance)
				{
					...
					monster.broadcastPacket(new NpcSay(monster.getObjectId(), 0, monster.getNpcId(), MOBSTEXT.get(Integer.valueOf(monster.getNpcId()))));
	...
	{
		new ReedFields(ReedFields.class.getSimpleName(), "ai/group_temple");
	}
}