...
public class TerritoryManagers extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			case "36490-04.html":
			{
				...
				html.setFile(player.getHtmlPrefix(), "data/scripts/npc/TerritoryManagers/36490-04.html");
			...
			case "CalcRewards":
			{
				...
				{
					html.setFile(prefix, "data/scripts/npc/TerritoryManagers/reward-0a.html");
				}
				else if (reward[0] != territoryId)
				{
					html.setFile(prefix, "data/scripts/npc/TerritoryManagers/reward-0b.html");
				...
				{
					html.setFile(prefix, "data/scripts/npc/TerritoryManagers/reward-1.html");
					html.replace("%castle%", CastleManager.getInstance().getCastleById(reward[0] - 80).getName());
			...
			case "ReceiveRewards":
			{
				...
				if (TerritoryWarManager.getInstance().isTWInProgress() || (reward[0] == 0))
				{
					html.setFile(player.getHtmlPrefix(), "data/scripts/npc/TerritoryManagers/reward-0a.html");
				}
				else if (reward[0] != territoryId)
				{
					html.setFile(player.getHtmlPrefix(), "data/scripts/npc/TerritoryManagers/reward-0b.html");
					html.replace("%castle%", CastleManager.getInstance().getCastleById(reward[0] - 80).getName());
				}
				else if (reward[1] == 0)
				{
				...
				{
					html.setFile(player.getHtmlPrefix(), "data/scripts/npc/TerritoryManagers/reward-2.html");
	...
	{
		super(TerritoryManagers.class.getSimpleName(), "npc/");
