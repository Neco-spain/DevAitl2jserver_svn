...
public class PcBangPoint extends Quest
{
	...
	private static final int[] NPCs =
	{
		...
		31991, 31992, 31993, 31994, 31995, 32337, 32338, 32339, 32340,30026, 
		//Added by RobikBobik - bonus for users of L2PS
		30026, 30031, 30037, 30066, 30070, 30109, 30115, 30120, 30129, 30141, 30154, 30174, 
		30175, 30176, 30187, 30191, 30195, 30288, 30289, 30290, 30297, 30305, 30358, 30359, 
		30373, 30462, 30474, 30498, 30499, 30500, 30503, 30504, 30505, 30508, 30511, 30512, 
		30513, 30520, 30525, 30565, 30594, 30595, 30676, 30677, 30681, 30685, 30687, 30689, 
		30694, 30699, 30704, 30845, 30847, 30849, 30854, 30857, 30862, 30865, 30894, 30897, 
		30900, 30905, 30910, 30913, 31269, 31272, 31276, 31279, 31285, 31288, 31314, 31317, 
		31321, 31324, 31326, 31328, 31331, 31334, 31336, 31755, 31958, 31961, 31965, 31968, 
		31974, 31977, 31996, 32092, 32093, 32094, 32095, 32096, 32097, 32098, 32139, 32140, 
		32145, 32146, 32147, 32150, 32153, 32154, 32157, 32158, 32160, 32171, 32193, 32196, 
		32199, 32020, 32205, 32206, 32209, 32210, 32213, 32214, 32217, 32218, 32221, 32222, 
		32225, 32226, 32229, 32230, 32233, 32234, 32202
	};
	/**
	...
	static
	{
		...
		// Towns
		//Added by RobikBobik
		TELEPORTERS.put("TELE_100", new int[] { 82698, 148638, -3473, 30 }); //Giran
		TELEPORTERS.put("TELE_101", new int[] { 147450, 27064, -2208, 30 }); //Aden
		TELEPORTERS.put("TELE_102", new int[] { 147725, -56517, -2780, 30 }); //Goddard
		TELEPORTERS.put("TELE_103", new int[] { 44070, -50243, -796, 30 }); //Rune
		TELEPORTERS.put("TELE_104", new int[] { 18748, 145437, -3132, 30 }); //Dion
		TELEPORTERS.put("TELE_105", new int[] { 82321, 55139, -1529, 30 }); //Oren
		TELEPORTERS.put("TELE_106", new int[] { -14225, 123540, -3121, 30 }); //Gludio
		TELEPORTERS.put("TELE_107", new int[] { -83063, 150791, -3133, 30 }); //Gludin
		TELEPORTERS.put("TELE_108", new int[] { 87358, -141982, -1341, 30 }); //Shuttgart
		TELEPORTERS.put("TELE_109", new int[] { 111115, 219017, -3547, 30 }); //Heine
		TELEPORTERS.put("TELE_110", new int[] { 116589, 96268, -2734, 30 }); //Hunters
		TELEPORTERS.put("TELE_111", new int[] { 17144, 170156, -3502, 30 }); //Floran
		// Start Towns
		//Added by RobikBobik
		TELEPORTERS.put("TELE_112", new int[] { -82687, 243157, -3734, 100 }); //Human
		TELEPORTERS.put("TELE_113", new int[] { -44133, -113911, -244, 100 }); //Orc
		TELEPORTERS.put("TELE_114", new int[] { 45873, 49288, -3064, 100 }); //Elven
		TELEPORTERS.put("TELE_115", new int[] { 116551, -182493, -1525, 100 }); //Dwarven
		TELEPORTERS.put("TELE_116", new int[] { 12428, 16551, -4588, 100 }); //Dark Elven
		TELEPORTERS.put("TELE_117", new int[] { -116934, 46616, 368, 100 }); //Kamael
	}
