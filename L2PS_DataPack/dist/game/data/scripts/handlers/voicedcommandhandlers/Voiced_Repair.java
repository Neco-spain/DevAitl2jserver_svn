...
public class Voiced_Repair implements IVoicedCommandHandler
{
	static final Logger _log = Logger.getLogger(Voiced_Repair.class.getName());
	...
	public boolean useVoicedCommand(String command, L2PcInstance activeChar, String target)
	{
		...
		{
			String htmContent = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "data/html/mods/menu/menu.htm");
			NpcHtmlMessage npcHtmlMessage = new NpcHtmlMessage(5);
			npcHtmlMessage.setHtml(htmContent);
			activeChar.sendPacket(npcHtmlMessage);
			return true;
