...
public class NpcBuffer extends Quest
{
    ...
    private static final String TITLE_NAME = "Schema Buffer";
    ...
    /*--String[] eventSplit = event.split(" ");--*/
        ...
        switch (eventParam0)
        {
            ...
            case "viewSelectedConfig": throw new RuntimeException();

            case "changeConfig": throw new RuntimeException();
